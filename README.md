...
- A UI só deve mostrar **unsupported** quando nenhum endpoint real alternativo existir. Quando existir caminho parcial/fallback, o toggle fica acionável e o log mostra exatamente o que foi aplicado ou pulado.
